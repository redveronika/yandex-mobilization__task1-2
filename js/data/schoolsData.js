...
let schools = checkStorage('schools', schoolsConst);
let locations = checkStorage('locations', locationsConst);
let lectures = checkStorage('lectures', lecturesConst);
let speakers = checkStorage('speakers', speakersConst);
